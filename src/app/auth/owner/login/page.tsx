  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.user.userType !== "owner") {
        toast.error("This account is not an owner account");
        return;
      }
      ...
      <div className="hidden lg:flex flex-1 relative bg-sidebar overflow-hidden items-center justify-center">
        ...
        <div className="max-w-lg text-left z-10 p-12">
          ...
          <p className="text-xl text-muted-foreground">
            Take full control of your parking locations, track realtime revenue, and boost utilization.
          </p>
        </div>
      </div>
        ...
        <div className="w-full max-w-md relative z-10">
          <Card className="bg-card/60 backdrop-blur-xl border-white/5 shadow-2xl">
            <CardHeader className="space-y-2 pb-8">
              <CardTitle className="text-3xl font-bold">Owner Portal</CardTitle>
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex justify-end">
                  <Link href="/auth/owner/forgot-password" className="text-sm text-primary hover:underline">
                    Forgot password?
                  </Link>
                </div>
              ...
              <div className="mt-8 text-center text-sm text-muted-foreground">
                ...
                <Link href="/auth/owner/signup" className="text-primary font-medium hover:underline">
                  Partner with us
                </Link>
              </div>
            </CardContent>
